  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-28 px-6">
      ...
      <p className="text-sm max-w-xs mb-6" style={{ color: dark ? "#666" : "#888" }}>
        Get {FREE_CREDITS} free resume checks. No credit card needed.
      </p>
      <button
        onClick={onLogin}
...
function NoCreditsGate({ dark, onSubscribe }) {
  return (
    <div className="flex flex-col items-center justify-center text-center py-28 px-6">
      ...
      <p className="text-sm max-w-xs mb-6" style={{ color: dark ? "#666" : "#888" }}>
        Upgrade to Pro for unlimited resume analysis.
      </p>
      <button
        onClick={onSubscribe}
        className="flex items-center gap-2 text-sm font-bold px-5 py-2.5 rounded-lg"
...
export default function ResumeChecker({ dark, onLogin, onSubscribe }) {
          ...
          <div className="px-6 sm:px-8 py-6 space-y-4">
            ...
            {!isPro && (
              <p className={`text-center text-xs ${dark ? "text-stone-600" : "text-stone-400"}`}>
                ...
                <button onClick={onSubscribe} className="underline" style={{ color: "#F5A623" }}>
